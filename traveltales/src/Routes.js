    ...
    <Stack.Navigator>
      <Stack.Screen
        ...
        options={{
          ...
          headerRight: () => (
            <TouchableOpacity style={{ marginRight: 48 }} onPress={() => {}}>
      ...
      <Nav.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => {
            ...
            return (
              <Ionicons name="bookmark-outline" size={28} color={"#E88046"} />
            );
          },
        }}
      />
      <Nav.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => {
            if (focused) {
              return (
                <Ionicons name="search-circle" size={28} color={"#E88046"} />
              );
            }
      ...
      <Nav.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ focused }) => {
            ...
            return (
              <Ionicons name="person-outline" size={28} color={"#E88046"} />
            );
          },
        }}
      />
